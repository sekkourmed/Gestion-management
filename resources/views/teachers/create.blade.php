...
@section('page-title')
	<h1 class="page-title"><i class="fe fe-user-plus"></i> Nouveau etudiant</h1>
...
<div class="card">
	...
	<div class="card-header">
		<h3 class="card-title">Ajouter nouveau etudiant</h3>
	</div>
			...
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
						...
						<input type="text" name="last_name" class="form-control {{ $errors->has('last_name') ? ' is-invalid' : '' }}" placeholder="Nom" value="{{ old('last_name') }}" required autofocus />
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<input type="text" name="first_name" class="form-control {{ $errors->has('first_name') ? ' is-invalid' : '' }}" placeholder="Prénom" value="{{ old('first_name') }}" required autofocus />
			...
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
						...
						<input type="email" name="email" class="form-control {{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="E-mail" value="{{ old('email') }}" required autofocus />
						@if ($errors->has('email'))
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<input type="text" name="tel" class="form-control{{ $errors->has('tel') ? ' is-invalid' : '' }}" placeholder="Telephone" value="{{ old('tel') }}" required autofocus />
						@if ($errors->has('tel'))
